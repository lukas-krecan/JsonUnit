...
class ConfigurationWithDummyDifferenceListener extends ConfigurationSourceWrapper {
    ConfigurationWithDummyDifferenceListener(ConfigurationSource wrapped) {
        super(wrapped);
    }

    @Override
    public DifferenceListener getDifferenceListener() {
        return dummyDifferenceListener();
    }
}
